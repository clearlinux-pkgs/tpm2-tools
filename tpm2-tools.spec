...
Source0  : https://github.com/tpm2-software/tpm2-tools/releases/download/5.1.1/tpm2-tools-5.1.1.tar.gz
Source1  : https://github.com/tpm2-software/tpm2-tools/releases/download/5.1.1/tpm2-tools-5.1.1.tar.gz.asc
...
%prep
%setup -q -n tpm2-tools-5.1.1
cd %{_builddir}/tpm2-tools-5.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624297333
...
cp %{_builddir}/tpm2-tools-5.1.1/doc/LICENSE %{buildroot}/usr/share/package-licenses/tpm2-tools/e8566cc4b6c5a67bda0376f10f71d0df00e262a9
%make_install

...
Source0  : https://github.com/tpm2-software/tpm2-tools/releases/download/5.6/tpm2-tools-5.6.tar.gz
...
%prep
%setup -q -n tpm2-tools-5.6
cd %{_builddir}/tpm2-tools-5.6
pushd ..
cp -a tpm2-tools-5.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699556380
...
/usr/share/man/man1/tpm2_tr_encode.1

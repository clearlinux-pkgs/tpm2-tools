...
Source0  : https://github.com/tpm2-software/tpm2-tools/releases/download/4.2/tpm2-tools-4.2.tar.gz
Source1  : https://github.com/tpm2-software/tpm2-tools/releases/download/4.2/tpm2-tools-4.2.tar.gz.asc
...
%prep
%setup -q -n tpm2-tools-4.2
cd %{_builddir}/tpm2-tools-4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588802574
...
cp %{_builddir}/tpm2-tools-4.2/doc/LICENSE %{buildroot}/usr/share/package-licenses/tpm2-tools/e8566cc4b6c5a67bda0376f10f71d0df00e262a9
%make_install
...
/usr/share/bash-completion/completions/tpm2_eventlog
...
/usr/share/bash-completion/completions/tpm2_policycphash

...
Source0  : https://github.com/tpm2-software/tpm2-tools/releases/download/5.7/tpm2-tools-5.7.tar.gz
...
%prep
%setup -q -n tpm2-tools-5.7
cd %{_builddir}/tpm2-tools-5.7
pushd ..
cp -a tpm2-tools-5.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714146169
